program main
    ...
    use test_frkmin
    use test_frkmin_q
    use test_genqist, only: test_make_spice_subset, test_make_rotation, test_grav_load, test_gq_init, test_kernel_write
    use test_makemodel, only: test_kep_grav, test_threebody_grav, test_SH_grav, end_to_end_integration_test
    logical testpass
