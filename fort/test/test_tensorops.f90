module test_tensorops
    ...
    contains
        ...
        subroutine test_basic_tensorops_d(testpass)
            ...
            ! STMinvert8
                stminvert8_truth(1,:) =  [ 0.01684607_dp, -0.02049215_dp, -0.00492154_dp,  0.00023436_dp,  0.01364028_dp,&
                0.00309208_dp, -0.0174303_dp,  0.01145994_dp]
                stminvert8_truth(2,:) =  [-0.05263277_dp,  0.03873808_dp, -0.01003245_dp, -0.01360167_dp, -0.01584197_dp,&
                0.01094427_dp,  0.03666172_dp, -0.00671567_dp]
                stminvert8_truth(3,:) =  [-0.01830201_dp,  0.03185471_dp,  0.01231027_dp, -0.02074384_dp, -0.02911729_dp,&
                0.01512645_dp,  0.02883093_dp, -0.01319872_dp]
                stminvert8_truth(4,:) =  [ 0.0121908_dp, -0.03885463_dp, -0.01532077_dp,  0.02289227_dp,  0.02725751_dp,&
                -0.01398507_dp, -0.01438121_dp,  0.0160061_dp]
                stminvert8_truth(5,:) =  [ 0.00310332_dp,  0.11799515_dp,  0.1345172_dp, -0.09211388_dp, -0.10954499_dp,&
                0.04305073_dp,  0.04573723_dp, -0.06976503_dp]
                stminvert8_truth(6,:) =  [ 0.00150244_dp, -0.02015711_dp, -0.02413202_dp,  0.02898049_dp,  0.02012894_dp,&
                -0.01155453_dp, -0.02071762_dp,  0.0141881_dp]
                stminvert8_truth(7,:) =  [ 0.03374979_dp, -0.08094552_dp, -0.05577335_dp,  0.05802861_dp,  0.06445587_dp,&
                -0.03950086_dp, -0.04521933_dp,  0.04392145_dp]
                stminvert8_truth(8,:) =  [ 0.01147961_dp, -0.03325185_dp, -0.04083109_dp,  0.02487578_dp,  0.03992714_dp,&
        ...
        subroutine test_basic_tensorops_q(testpass)
            ...
            ! STMinvert8
                stminvert8_truth(1,:) =  [ 0.01684607_qp, -0.02049215_qp, -0.00492154_qp,  0.00023436_qp,  0.01364028_qp,&
                0.00309208_qp, -0.0174303_qp,  0.01145994_qp]
                stminvert8_truth(2,:) =  [-0.05263277_qp,  0.03873808_qp, -0.01003245_qp, -0.01360167_qp, -0.01584197_qp,&
                0.01094427_qp,  0.03666172_qp, -0.00671567_qp]
                stminvert8_truth(3,:) =  [-0.01830201_qp,  0.03185471_qp,  0.01231027_qp, -0.02074384_qp, -0.02911729_qp,&
                0.01512645_qp,  0.02883093_qp, -0.01319872_qp]
                stminvert8_truth(4,:) =  [ 0.0121908_qp, -0.03885463_qp, -0.01532077_qp,  0.02289227_qp,  0.02725751_qp,&
                -0.01398507_qp, -0.01438121_qp,  0.0160061_qp]
                stminvert8_truth(5,:) =  [ 0.00310332_qp,  0.11799515_qp,  0.1345172_qp, -0.09211388_qp, -0.10954499_qp,&
                0.04305073_qp,  0.04573723_qp, -0.06976503_qp]
                stminvert8_truth(6,:) =  [ 0.00150244_qp, -0.02015711_qp, -0.02413202_qp,  0.02898049_qp,  0.02012894_qp,&
                -0.01155453_qp, -0.02071762_qp,  0.0141881_qp]
                stminvert8_truth(7,:) =  [ 0.03374979_qp, -0.08094552_qp, -0.05577335_qp,  0.05802861_qp,  0.06445587_qp,&
                -0.03950086_qp, -0.04521933_qp,  0.04392145_qp]
                stminvert8_truth(8,:) =  [ 0.01147961_qp, -0.03325185_qp, -0.04083109_qp,  0.02487578_qp,  0.03992714_qp,&
