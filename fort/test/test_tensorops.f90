    ...
    contains
        ...
        subroutine test_basic_tensorops_d(testpass)
            ...
            ! STMinvert8
                ...
                stminvert8_truth(4_dp,:) =  [ 0.0121908_dp, -0.03885463_dp, -0.01532077_dp,  0.02289227_dp,  0.02725751_dp,&
                -0.01398507_dp, -0.01438121_dp,  0.0160061_dp]
                stminvert8_truth(5_dp,:) =  [ 0.00310332_dp,  0.11799515_dp,  0.1345172_dp, -0.09211388_dp, -0.10954499_dp,&
        ...
        subroutine test_basic_tensorops_q(testpass)
            ...
            ! STMinvert8
                ...
                stminvert8_truth(4_qp,:) =  [ 0.0121908_qp, -0.03885463_qp, -0.01532077_qp,  0.02289227_qp,  0.02725751_qp,&
                -0.01398507_qp, -0.01438121_qp,  0.0160061_qp]
                stminvert8_truth(5_qp,:) =  [ 0.00310332_qp,  0.11799515_qp,  0.1345172_qp, -0.09211388_qp, -0.10954499_qp,&
