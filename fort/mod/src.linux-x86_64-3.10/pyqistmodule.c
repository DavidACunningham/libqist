 ...
 * Generation date: Thu Jul 11 19:00:20 2024
...
"tau : input float\n"
"\nReturns\n-------\n"
"res : rank-1 array('d') with bounds (8) and pw_statef2pywrap storage";
/* #declfortranroutine# */
...
/*decl*/
    ...
    double *pw_statef2pywrap = NULL;
    npy_intp pw_statef2pywrap_Dims[1] = {-1};
    const int pw_statef2pywrap_Rank = 1;
    PyArrayObject *capi_pw_statef2pywrap_as_array = NULL;
    int capi_pw_statef2pywrap_intent = 0;
    double tau = 0;
...
/*frompyobj*/
    ...
    pw_statef2pywrap_Dims[0]=8;
    capi_pw_statef2pywrap_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    const char * capi_errmess = "pyqist.pyqist.pq.pw_state: failed to create array from the hidden `pw_statef2pywrap`";
    capi_pw_statef2pywrap_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,pw_statef2pywrap_Dims,pw_statef2pywrap_Rank,  capi_pw_statef2pywrap_intent,Py_None,capi_errmess);
    if (capi_pw_statef2pywrap_as_array == NULL) {
        ...
        pw_statef2pywrap = (double *)(PyArray_DATA(capi_pw_statef2pywrap_as_array));
...
/*end of pyobjfrom*/
        CFUNCSMESS("Building return value.\n");
        capi_buildvalue = Py_BuildValue("N",capi_pw_statef2pywrap_as_array);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
        } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
    }  /* if (capi_pw_statef2pywrap_as_array == NULL) ... else of pw_statef2pywrap */
...
"ta : input float\n"
"tb : input float\n"
"xa : input rank-1 array('d') with bounds (6)\n"
"\nOther Parameters\n----------------\n"
"order : input int\n"
"\nReturns\n-------\n"
...
new_stm,new_stt = pw_tensor_change_of_basis(rno,old_stm,old_stt)\n\nWrapper for ``pw_tensor_change_of_basis``.\
\n\nParameters\n----------\n"
"rno : input rank-2 array('d') with bounds (8,8)\n"
...
/*decl*/
    ...
    double *rno = NULL;
    npy_intp rno_Dims[2] = {-1, -1};
    const int rno_Rank = 2;
    PyArrayObject *capi_rno_as_array = NULL;
    int capi_rno_intent = 0;
    PyObject *rno_capi = Py_None;
    double *old_stm = NULL;
    ...
    PyArrayObject *capi_new_stt_as_array = NULL;
    int capi_new_stt_intent = 0;
    static char *capi_kwlist[] = {"rno","old_stm","old_stt",NULL};
...
#endif
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OOO|:pyqist.pq.pw_tensor_change_of_basis",\
        capi_kwlist,&rno_capi,&old_stm_capi,&old_stt_capi))
        return NULL;
/*frompyobj*/
    /* Processing variable rno */
    rno_Dims[0]=8,rno_Dims[1]=8;
    capi_rno_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "pyqist.pyqist.pq.pw_tensor_change_of_basis: failed to create array from the 1st argument `rno`";
    capi_rno_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rno_Dims,rno_Rank,  capi_rno_intent,rno_capi,capi_errmess);
    if (capi_rno_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = pyqist_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        rno = (double *)(PyArray_DATA(capi_rno_as_array));

    /* Processing variable old_stm */
    old_stm_Dims[0]=8,old_stm_Dims[1]=8;
    capi_old_stm_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "pyqist.pyqist.pq.pw_tensor_change_of_basis: failed to create array from the 2nd argument `old_stm`";
    ...
    const char * capi_errmess = "pyqist.pyqist.pq.pw_tensor_change_of_basis: failed to create array from the 3rd argument `old_stt`";
...
#endif
/*callfortranroutine*/
                (*f2py_func)(rno,old_stm,old_stt,new_stm,new_stt);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
    ...
    if((PyObject *)capi_rno_as_array!=rno_capi) {
        Py_XDECREF(capi_rno_as_array); }
    }  /* if (capi_rno_as_array == NULL) ... else of rno */
    /* End of cleaning variable rno */
/*end of cleanupfrompyobj*/
    if (capi_buildvalue == NULL) {
/*routdebugfailure*/
    } else {
...
static void f2py_setup_pq(char *pw_init_v,char *pw_init_n,char *pw_state,char *pw_stm,char *pw_stt,char *pw_stm_i,char *pw_stt_i,char *pw_prop_once,char *pw_prop_many,char *pw_stts_ab,char *pw_stt_update,char *pw_tensor_change_of_basis,char *pw_zmap) {
  int i_f2py=0;
...
extern void F_FUNC(f2pyinitpq,F2PYINITPQ)(void (*)(char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  pq --- pw_init_v(),pw_init_n(),pw_state(),pw_stm(),pw_stt(),pw_stm_i(),pw_stt_i(),pw_prop_once(),pw_prop_many(),pw_stts_ab(),pw_stt_update(),pw_tensor_change_of_basis(),pw_zmap()"".");
