 ...
 * Generation date: Mon Jul 15 20:04:19 2024
...
new_stm,new_stt = pw_tensor_change_of_basis(rnof,rno0,old_stm,old_stt)\n\nWrapper for ``pw_tensor_change_of_basis``.\
\n\nParameters\n----------\n"
"rnof : input rank-2 array('d') with bounds (8,8)\n"
"rno0 : input rank-2 array('d') with bounds (8,8)\n"
...
/*decl*/
    ...
    double *rno0 = NULL;
    npy_intp rno0_Dims[2] = {-1, -1};
    const int rno0_Rank = 2;
    PyArrayObject *capi_rno0_as_array = NULL;
    int capi_rno0_intent = 0;
    PyObject *rno0_capi = Py_None;
    double *old_stm = NULL;
    ...
    PyArrayObject *capi_new_stt_as_array = NULL;
    int capi_new_stt_intent = 0;
    static char *capi_kwlist[] = {"rnof","rno0","old_stm","old_stt",NULL};
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        ...
        capi_kwlist,&rnof_capi,&rno0_capi,&old_stm_capi,&old_stt_capi))
        return NULL;
/*frompyobj*/
    ...
    /* Processing variable rno0 */
    rno0_Dims[0]=8,rno0_Dims[1]=8;
    capi_rno0_intent |= F2PY_INTENT_IN;
    const char * capi_errmess = "pyqist.pyqist.pq.pw_tensor_change_of_basis: failed to create array from the 2nd argument `rno0`";
    capi_rno0_as_array = ndarray_from_pyobj(  NPY_DOUBLE,1,rno0_Dims,rno0_Rank,  capi_rno0_intent,rno0_capi,capi_errmess);
    if (capi_rno0_as_array == NULL) {
        PyObject* capi_err = PyErr_Occurred();
        if (capi_err == NULL) {
            capi_err = pyqist_error;
            PyErr_SetString(capi_err, capi_errmess);
        ...
        rno0 = (double *)(PyArray_DATA(capi_rno0_as_array));
...
#endif
/*callfortranroutine*/
                (*f2py_func)(rnof,rno0,old_stm,old_stt,new_stm,new_stt);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
    ...
    if((PyObject *)capi_rno0_as_array!=rno0_capi) {
        Py_XDECREF(capi_rno0_as_array); }
    }  /* if (capi_rno0_as_array == NULL) ... else of rno0 */
    /* End of cleaning variable rno0 */
