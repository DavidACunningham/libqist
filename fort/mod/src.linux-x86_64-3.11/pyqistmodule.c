/* File: pyqistmodule.c
 * This file is auto-generated with f2py (version:2.2.5).
 * f2py is a Fortran to Python Interface Generator (FPIG), Second Edition,
 * written by Pearu Peterson <pearu@cens.ioc.ee>.
 * Generation date: Mon Apr 28 17:17:11 2025
...
PyMODINIT_FUNC PyInit_pyqist(void) {
    ...
    s = PyUnicode_FromString("2.2.5");
    PyDict_SetItemString(d, "__version__", s);
    Py_DECREF(s);
    s = PyUnicode_FromString(
        "This module 'pyqist' is auto-generated with f2py (version:2.2.5).\nFunctions:\n"
